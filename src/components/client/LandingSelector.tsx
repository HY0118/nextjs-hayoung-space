      ...
      <div className="w-full max-w-3xl bg-background rounded-2xl shadow-2xl border border-border/40 overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-6 p-8">
          ...
          >
            ...
            <p className="text-text-secondary mb-3">홈, 기술, 프로젝트를 자유롭게 탐색합니다.</p>
            ...
            <div className="mt-auto ml-auto text-primary opacity-0 group-hover:opacity-100 transition-opacity pt-4">자유롭게 둘러보기 →</div>
          </button>
          <button
            onClick={() => {
              choose("portfolio");
          ...
          >
            ...
            <p className="text-text-secondary mb-3">간단 이력과 대표 작업 위주로 살펴봅니다.</p>
            <div className="flex flex-wrap gap-2 mb-3">
            ...
            <div className="mt-auto ml-auto text-primary opacity-0 group-hover:opacity-100 transition-opacity pt-4">핵심만 빠르게 보기 →</div>
          </button>
        </div>
      </div>
    </div>
